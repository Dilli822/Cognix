  ...
  if (whiteTurn && isKing === "♕") {
    if (
      ...
      possibleMoves.forEach((id) => {
        ...
        squareElement.addEventListener("click", function () {
          alert(`You clicked on square with ID: ${id}`);
          if (
            ...
            // Clear the content of the clicked square
    ...
    if (clickedSquareId === 1) {
      ...
      possibleMoves.forEach((id) => {
        ...
        squareElement.addEventListener("click", function () {
          ...
          // if (
          //   document.getElementById(id.toString()).innerHTML === "" ||
          //   ["♟", "♜", "♞", "♝", "♛", "♚"].includes(document.getElementById(id.toString()).innerHTML) &&
          //   !["♙", "♖", "♘", "♗", "♕", "♔"].includes(document.getElementById(id.toString()).innerHTML)
          // ) {
          //   // Clear the content of the clicked square
          //   document.getElementById(clickedSquareId.toString()).innerHTML = "";
    ...
    if (a === "false") {
      document.getElementById("turn").innerHTML =
        "<p> Black Turn: True <br> White Turn: False </p>";
    }
  }
    ...
    if (
      ...
      possibleMoves.forEach((id) => {
        ...
        squareElement.addEventListener("click", function () {
          ...
          alert(`You clicked on square with ID: ${clickedId}`);
