...
export let iblackPawns = ["black-pawn1", "black-pawn2", "black-pawn3", "black-pawn4", "black-pawn5", "black-pawn6", "black-pawn7", "black-pawn8"];
export let iwhitePawns = ["white-pawn1", "white-pawn2", "white-pawn3", "white-pawn4", "white-pawn5", "white-pawn6", "white-pawn7", "white-pawn8"];
...
export let initial_BlackSideOne_GapForPawns = ["wbox9", "bbox9", "wbox10", "bbox10", "wbox11", "bbox11", "wbox12", "bbox12"];

export let initial_BlackSide_TwoGapForPawns = ["wbox9", "bbox9", "wbox10", "bbox10", "wbox11", "bbox11", "wbox12", "bbox12", "bbox13", "wbox13", "bbox14", "wbox14", "bbox15", "wbox15", "bbox16", "wbox16"];

export let initial_WhiteSideOne_GapForPawns = ["wbox17", "bbox17", "wbox18", "bbox18", "wbox19", "bbox19", "wbox20", "bbox20"];

export let initial_WhiteSide_TwoGapForPawns = ["wbox17", "bbox17", "wbox18", "bbox18", "wbox19", "bbox19", "wbox20", "bbox20", "bbox21", "wbox21", "bbox22", "wbox22", "bbox23", "wbox23", "bbox24", "wbox24"];
    ...
    pawnIds.forEach(function (pawnId) {
        ...
        if (pawnElement) {
            pawnElement.addEventListener("click", function () {
                ...
                } else if (initial_box_mapping_for_white_pawns.hasOwnProperty(pawnId)) {
