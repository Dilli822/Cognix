...
function handleClick(event) {
  ...
  if (isBlackBox) {
    ...
    if (destinationBoxContent === "") {
      ...
      console.log(
        "from black part to white side Destination box is occupied and it is enemy"
      );
      ...
      console.log(
        "from black part to white side Destination box is occupied and it is friend"
      );
    }
  }
  ...
  if (isWhiteBox) {
    ...
    if (squareContent === "♟") {
      possibleStep = currentBoxNumber + 4;
      // diagonalLeft = currentBoxNumber + 5;
    } else {
      possibleStep = currentBoxNumber - 4;
      diagonalLeft = currentBoxNumber - 5;
    }
    ...
    const destinationLeftBoxId = `bbox${diagonalLeft}`;
    // const destinationRightBoxId = `bbox${diagonalRight}`;

    console.log("left",destinationLeftBoxId)
    console.log("middle",destinationBoxId)
    // console.log("right",destinationRightBoxId)
    ...
    if (destinationBoxContent === "") {
      ...
      console.log(
        "from black part to white side DIAGONAL RIGHT Destination box is occupied and it is friend"
      );
